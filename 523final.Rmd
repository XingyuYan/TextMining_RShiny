...
This shiny app basically implements Part 1 and Part 2, but it allows users to upload their own text file and also customize the visualization. On the sidebar panel 
```{r}
# load packages
# library(shiny)
